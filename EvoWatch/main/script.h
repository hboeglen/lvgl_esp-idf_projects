...
"function getData() {"
  ...
  "xtemp.send();"
  "var xpress = new XMLHttpRequest();"
  "xpress.onreadystatechange = function() {"
	"if (this.readyState == 4 && this.status == 200) {"
	  "document.getElementById(\"press_value\").innerHTML ="
	  "this.responseText;"
	"}"
  "};"
  "xpress.open(\"GET\", \"press\", true);"
  "xpress.send();"
"}"
"</script>";
...
const char BootstrapJS[] = "/*!"
		...
		"  "
		"var tempdelay = 1000;"
		"setInterval(function() {" //My function
		  "getData();"
		"}, tempdelay);"
		"function getData() {"
		  "var xtemp = new XMLHttpRequest();"
		  ...
		  "xpress.open(\"GET\", \"press\", true);"
		  "xpress.send();"
		  "var xsteps = new XMLHttpRequest();"
		  "xsteps.onreadystatechange = function() {"
			"if (this.readyState == 4 && this.status == 200) {"
			  "document.getElementById(\"steps_value\").innerHTML ="
			  "this.responseText;"
			"}"
		  "};"
		  "xsteps.open(\"GET\", \"steps\", true);"
		  "xsteps.send();"
		"}"//end of my function
		...
		"  "
		"  })(jQuery); "
		"var slider = document.getElementById(\"RefreshTemp\");"
		...
		"var xhr = new XMLHttpRequest();"
			...
			"xhr.onreadystatechange = function() {"
				...
				"}"
			"};"
		"xhr.send(alarm.value);"
		"}";

const char BootstrapCSS[] = "@charset \"UTF-8\";"
":root {"
"  --blue: #007bff;"
"  --indigo: #6610f2;"
"  --purple: #6f42c1;"
